      ...
      <div className="flex gap-5 items-start">
        <Card className="bg-[#146EB4] text-white flex flex-col gap-4 w-1/3">
          <>
            <div className="flex items-center gap-2 px-5 pt-4">
              <span>
                <p className="font-normal">Next Payout</p>
              </span>
              <span>
                <svg
                  width="14"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_99928_4426)">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
            ...
            <div className="flex justify-between items-center gap-8 px-5">
              <h2 className="text-3xl font-medium p-0 m-0">₹2,312.23</h2>
              <div className="flex items-center">
                <span>
                  <p className="font-medium text-sm opacity-80">23 orders</p>
                </span>
                <span>
                  <svg
                    width="20"
            ...
            <div className="bg-[#0E4F82] w-full flex justify-between items-center rounded-md py-2 px-5   ">
              <p className="font-normal text-sm">Next payout date:</p>
              <p className="font-medium text-sm">Today, 04:00PM</p>
            </div>
          </>
        </Card>
        <Card className="px-5 py-5 flex flex-col gap-4 w-1/3">
          <>
            ...
            <div className="flex justify-between items-center gap-6">
              <h3 className="font-bold text-2xl">₹92,312.20</h3>

              <div className="flex gap-1 items-center">
                <span>
                  <p className="text-[#146EB4] text-sm font-normal">
                    13 orders
                  </p>
                </span>
                <span>
        ...
        <Card className="flex flex-col gap-4 p-5 w-1/3">
          <>
            ...
            <h3 className="font-bold text-2xl">₹23,92,312.19</h3>
          </>
        </Card>
      </div>
    </section>
