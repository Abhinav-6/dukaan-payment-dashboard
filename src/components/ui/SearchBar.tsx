function SearchBar() {
  return (
    <div className="px-2 py-2 bg-[#F2F2F2] flex rounded-full md:rounded items-center gap-2 self-stretch border-2 border-gray-200 focus-within:border-3 focus-within:border-gray-400">
      <span>
        <svg
          width="16"
          height="16"
        ...
        >
          <g clipPath="url(#clip0_99928_4430)">
            <path
      ...
      <input
        type="text"
        className=" w-full bg-[#f2f2f2] border-3 border-gray-200 outline-none "
