...
export default function Table() {
  ...
  return (
    <div className="px-4 md:px-8 w-full flex flex-col gap-2 md:gap-4 ">
      <div className="flex items-center justify-between ">
        <div className="relative flex items-center gap-1 border border-gray-400 rounded w-1/2 md:w-auto px-2 focus-within:border-2 focus-within:border-gray-500">
          <span className="pointer-events-none cursor-text">
            ...
            >
              <g clipPath="url(#clip0_99928_75730)">
                <path
          ...
          <input
            type="text"
            className="w-full bg-inherit focus:outline-none py-1.5 md:py-2 block"
            placeholder="Order ID or Transaction ID"
          />
        </div>
        <div className="flex items-center gap-1 md:gap-2">
          <div className="flex items-center gap-2 border border-gray-300 rounded px-2 md:px-4 py-1.5 md:py-2 hover:shadow hover:bg-gray-200 cursor-pointer transition-all">
            <p>Sort</p>
            <span>
              <svg
                width="14"
          ...
          <div className="border border-gray-300 rounded px-2 md:px-4 py-2 hover:shadow hover:bg-gray-200 cursor-pointer transition-all">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
      ...
      <div className="overflow-auto">
        <table className="table-fixed border-collapse px-2 text-sm text-left w-full min-w-[64rem]">
          <thead>
            <tr>
              <th
                scope="col"
                className="px-6 py-4 font-medium text-nowrap whitespace-nowrap"
              >
                Order Id
              </th>
              <th
