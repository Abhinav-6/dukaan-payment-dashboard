...
export default function Header() {
  return (
    <header className="border border-gray-300 flex justify-between px-8 py-3 items-center ">
      <div className="flex items- gap-2 items-center">
        ...
        <div className="flex items-center gap-1">
          ...
          <span>
            <p className="font-normal  text-gray-500 text-xs">How it works</p>
          </span>
        </div>
      </div>
      <div>
      ...
      <div className="flex gap-2">
        <span>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_99928_4436)">
        ...
        <span>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_99928_4441)">
              <circle cx="20" cy="20" r="20" fill="#E6E6E6" />
              <path
